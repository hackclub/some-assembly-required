;; x86 Intel syntax
; yasm -f macho64 cmdargs-uppercase.asm && ld cmdargs-uppercase.o -o cmdargs-uppercase -macosx_version_min 12.4 -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem && ./cmdargs-uppercase
